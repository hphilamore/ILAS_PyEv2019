...
cfg.window = pygame.display.set_mode((win_width, win_height))
...
#            pad2_pos[y] += pad2_vel[y]
    ...
    pygame.draw.circle(cfg.window, red, (int(cfg.ball_pos[x]), int(cfg.ball_pos[y])), radius)
    pygame.draw.rect(cfg.window, white, pygame.Rect(int(cfg.pad1_pos[x]), int(cfg.pad1_pos[y]), pad_width, pad_height))
    pygame.draw.rect(cfg.window, white, pygame.Rect(int(cfg.pad2_pos[x]), int(cfg.pad2_pos[y]), pad_width, pad_height))
